  ...
  <div class="page-wiki-detail">
    <div class="header-info">
      ...
      <div class="base-info">
        ...
        <p class="g-margin-top description">简介：{{ wikiInfo.summary }}</p>
      </div>
    </div>
    <p class="mobile-description">简介：{{ wikiInfo.summary }}</p>
      ...
      <a-collapse v-model="activeKey" @change="collapseChange">
        ...
        <a-collapse-panel key="1" header="点击这里贡献知识库文章">
          <div class="contribute-container">
            <a-alert
              message="您提交的文章信息我们会尽快审核和整理，优质文章将被收纳进知识库，期待您的参与~"
              banner
            />
            <div class="submit-item">
              ...
              <a-input
                ref="articleUrl"
                v-model="articleUrl"
                placeholder="请输入文章url（支持任何网站的文章地址）"
              />
            </div>
