...
export default {
  ...
  asyncData ({ redirect, store }) {
    ...
    if (userInfo) {
      ...
      redirect('http://it.talkweb.com.cn/idaas/login?client_id=1834156237792284674&redirect_uri=http%3A%2F%2F192.168.35.12%3A19102%2F%23%2FloginRedirect&response_type=code')
